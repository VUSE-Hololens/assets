...
namespace HoloToolkit.Examples.InteractiveElements
{
    ...
    public class SliderGestureControl : GestureInteractiveControl
    {
        ...
        public void SetSliderValue(float value)
        {
            ...
            mDeltaValue = (SliderValue - MinSliderValue) / (MaxSliderValue - MinSliderValue);
            UpdateVisuals();
            mCachedValue = mDeltaValue;

            // added by Mark Scherer, June 2018 because setting of mSliderValue in this method was not 
                // triggering Invoke within mySliderValue.set defintion.
            OnUpdateEvent.Invoke(mSliderValue);
