// Colored Mesh Shader
// Colors mesh according to Mesh.Color array, with triangle wireframe.
// Based on HoloToolkit/SpatialMapping/Wireframe.shader
		...
		fixed4 color : TEXCOORD2;
		   ...
		   o.color = i[idx].color;
            ...
            float4 frag(g2f i) : COLOR
            {
                ...
                float4 color = I * _WireColor + (1 - I) * i.color;
