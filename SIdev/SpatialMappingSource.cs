...
namespace HoloToolkit.Unity.SpatialMapping
{
    public class SpatialMappingSource : MonoBehaviour
    {
        ...
        /// <summary>
        /// List of extra data to accomdate SurfaceObjects
        /// </summary>
        public List<SurfacePoints> ExtraData;
        ...
        {
            // final two List<Vector3> custom added
            typeof(MeshFilter),
            typeof(MeshRenderer),
            typeof(MeshCollider)
        };
        ...
        public SpatialMappingSource()
        {
            ...
            ExtraData = new List<SurfacePoints>();
        }
